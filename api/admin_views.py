...
def api_keys_list(request):
    ...
    context = {'keys': keys}
    if request.htmx:
        return render(request, 'api/_partials/admin/api_keys/list.html', context)
    return render(request, 'api/admin/api_keys/index.html', context)
...
def api_keys_issue(request):
    ...
    if request.method == 'GET':
        return render(request, 'api/_partials/admin/api_keys/issue_form.html')
    ...
    if not worker_name:
        return render(
            request,
            'api/_partials/admin/api_keys/issue_form.html',
    ...
    return render(request, 'api/_partials/admin/api_keys/key_created.html', context)
...
def api_keys_revoke(request, key_id):
    ...
    return render(request, 'api/_partials/admin/api_keys/table_row.html', {'key': key})
